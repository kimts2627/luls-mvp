    ...
    <Layout>
      <div className="h-staticFull mt-28 w-full flex flex-col items-center">
        <header className="relative w-full h-1/3 overflow-hidden flex items-center">
          <img src="/img/berkeley-campus.jpeg" alt="" className="w-full z-0" />
          <div className="absolute top-0 bg-blue-900 opacity-60 w-full h-full z-10" />
        </header>
        <div className="absolute h-96 z-10 top-72">
